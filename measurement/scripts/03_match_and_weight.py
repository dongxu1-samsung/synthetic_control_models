...
IN_PATH = "/Users/dongd1.xu/Documents/hermes_agent/measurement/data/propensity_scored.parquet"
OUT_MATCHED_PATH = "/Users/dongd1.xu/Documents/hermes_agent/measurement/data/matched_pairs.parquet"
OUT_WEIGHTED_PATH = "/Users/dongd1.xu/Documents/hermes_agent/measurement/data/iptw_weighted.parquet"
...
# (a) 1:1 nearest-neighbor caliper matching on propensity score
# ==================================================================
CALIPER = 0.01  # standard rule of thumb: 0.2 * std(logit(p)); using a simple
                 # fixed caliper on the probability scale here for interpretability
...
# Note: 1:1 nearest-neighbor matching without replacement-tracking here uses
# WITH replacement (a given control row can serve as the nearest neighbor for
# more than one treated row) -- this is standard practice when the control
# pool is much larger than the treated pool (here ~2.4x), and avoids the
# match-order-dependence issue of without-replacement matching. Documented
# explicitly since it affects standard error calculation downstream (bootstrap
# resampling in the lift step accounts for this).
