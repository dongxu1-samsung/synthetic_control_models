"""
Step 17: Lift estimation on the MERGED Apple dataset.

Same methodology as 05_lift_estimation.py: naive/unadjusted, 1:1 caliper
matching (paired t-test), IPTW (stabilized, trimmed, bootstrap CI).
"""
import numpy as np
import pandas as pd
...
print("=" * 90)
print("LIFT ESTIMATION SUMMARY (MERGED DATASET) -- Flight 658095 / Campaign 296636")
print("=" * 90)
...
summary_df.to_csv(
    "/Users/dongd1.xu/Documents/hermes_agent/measurement/data/merged_lift_summary.csv", index=False
)
print("\nSaved lift summary to /Users/dongd1.xu/Documents/hermes_agent/measurement/data/merged_lift_summary.csv")
