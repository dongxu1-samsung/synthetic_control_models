...
Reports both binary conversion-rate lift and count-based (RAW_CONVERSIONS-style,
here CONVERTED_POST_EXPOSURE which is already binary in this feature table --
noted explicitly) lift with confidence intervals.
"""
import numpy as np
import pandas as pd
...
# two-proportion z-test for reference
...
# Bootstrap CI for IPTW lift (resample treated & control independently with
# replacement, recompute weighted rates each time)
...
# ------------------------------------------------------------------
print("=" * 90)
print("LIFT ESTIMATION SUMMARY -- Flight 658095 (Campaign 296636, Conversion Group 5534)")
print("=" * 90)
...
summary_df.to_csv(
    "/Users/dongd1.xu/Documents/hermes_agent/measurement/data/lift_summary.csv", index=False
)
print("\nSaved lift summary to /Users/dongd1.xu/Documents/hermes_agent/measurement/data/lift_summary.csv")
