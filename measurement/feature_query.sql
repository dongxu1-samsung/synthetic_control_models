SET PRE_CAMPAIGN_START = '2026-07-29';    -- 7-day pre-campaign feature window start
SET PRE_CAMPAIGN_END = '2026-08-04';      -- 7-day pre-campaign feature window end
SET CAMPAIGN_START = '2026-08-05';        -- Campaign observation window start (flight 658095)
SET CAMPAIGN_END = '2026-08-19';          -- Campaign observation window end (flight 658095)
SET MAPPING_DATE_START = '2026-07-08';    -- AB_ML_MAPPING date filter

-- 23 min
CREATE OR REPLACE TABLE UDW_PROD.UDW_PLATFORM_INTELLIGENCE_SS.PROPENSITY_FEATURES_APPLE AS (
    -- ============================================================
    ...
    tv_usage AS (
        ...
        WHERE PARTITION_DATE BETWEEN '20260729' AND '20260804'
        GROUP BY PSID
    ),
    -- ============================================================
    -- Pre-computed eligible user pool along with exposure and conversion
    -- Source: SYNTHETIC_CONTROL_MEASUREMENT_USER_POOL_3201807016597 (flight 658095)
    ...
    audience_users AS (
        ...
        FROM UDW_PROD.UDW_PLATFORM_INTELLIGENCE_SS.SYNTHETIC_CONTROL_MEASUREMENT_USER_POOL_3201807016597
